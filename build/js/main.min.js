...
},{"./modules/form-validate/form":3,"./modules/initswiper":9,"./modules/modals/init-modals":10,"./modules/tabs/init-tabs":12,"./modules/video":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var swiper = new _swiper.default('.coach__slider', {
  // Optional parameters
...
var review = new _swiper.default('.review__slider', {
  // Optional parameters
  direction: 'horizontal',
  loop: false,
  // Navigation arrows
...
},{"../../js/vendor/swiper":19}],10:[function(require,module,exports){
"use strict";
...
var videoPreview = document.querySelector('.intro__video');
var videoPicture = document.querySelector('.intro__picture');
var videoIframe = document.querySelector('.intro__iframe');
var videoButton = document.querySelector('.intro__play');
